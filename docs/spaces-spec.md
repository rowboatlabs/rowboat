...
> Imported on 2026-09-16 from [`rowboatlabs/harbor/SPACES_SPEC.md`](https://github.com/rowboatlabs/harbor/blob/28ffe08fdb6446a0d141441e93578c96ab54703e/SPACES_SPEC.md) at commit `28ffe08fdb6446a0d141441e93578c96ab54703e`.
> Spaces has launched. The source spec is preserved below, including its original draft status, dated decisions, deferred work, and open questions; these describe its design history and may differ from the shipped product.
> Related docs: [Spaces design language](spaces-design-language.md), [Harbor protocol contract](../apps/harbor/CONTRACT.md), and [push notification plan](../apps/harbor/PUSH_PLAN.md).
...
**Status:** Draft v1 · 2026-08-13 · Normative for the v1 dogfood slice.
...
Wire shape: `apps/harbor/CONTRACT.md` (notifications bullet); `PUSH_PLAN.md` for the phone half.
...
11. **Harbor repo timing.** When to extract Harbor from the monorepo into `rowboatlabs/harbor` with a one-command self-host path (likely: when third-party hosting is announced).
