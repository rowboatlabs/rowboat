...
const GROUPS: GroupSpec[] = [
  ...
  {
    title: "Assistant acting on your screen",
    description:
      "Only needed if you ask the assistant to click or type during a screen share. If you don't use that, leave these off — fewer grants is safer.",
    rows: [
      {
        key: "accessibility",
        title: "Accessibility",
        why: "Lets the assistant click and type for you when you ask.",
        hint: {
          denied:
            "If the checkbox in System Settings is already ON but clicking still fails (common after reinstalling an unsigned build), remove Rowboat from the list with “−” and re-add it.",
        },
