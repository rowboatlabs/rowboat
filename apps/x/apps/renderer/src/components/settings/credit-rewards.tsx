              ...
              <div key={activity.code} className="flex items-center gap-3 px-4 py-3">
                <div
                  className={cn(
                    ...
                    activity.claimed ? "bg-[var(--codex-success)]/15" : "bg-muted",
                  )}
                >
                  {activity.claimed ? (
                    <Check className="size-4 text-[var(--codex-success)]" />
                  ) : (
                ...
                <span
                  className={cn(
                    ...
                    activity.claimed
                      ? "bg-[var(--codex-success)]/15 text-[var(--codex-success)]"
          ...
          {referral && (
            <div className="flex items-center gap-3 px-4 py-3">
              <div
                className={cn(
                  "flex size-8 shrink-0 items-center justify-center rounded-full",
                  inviteSlotsLeft === 0 ? "bg-[var(--codex-success)]/15" : "bg-muted",
                )}
              >
                {inviteSlotsLeft === 0 ? (
                  <Check className="size-4 text-[var(--codex-success)]" />
              ...
              <div className="min-w-0 flex-1">
                ...
                {inviteSlotsLeft > 0 && (
                  <div className="mt-1.5 flex items-center gap-2">
                    ...
                    >
                      {copied ? <Check className="size-3 text-[var(--codex-success)]" /> : <Copy className="size-3" />}
                      {copied ? "Copied" : "Copy"}
                    </button>
                  </div>
                )}
