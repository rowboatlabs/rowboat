...
import { Archive, ArchiveRestore, Bot, MessageSquareOff, MessagesSquare, MoreHorizontal, Pencil } from 'lucide-react'
...
export function SpaceDiscussionsView({ orgId, spaceId, direct, topics, loaded, memberNames, spaceNames, presence, onOpen }: {
    orgId: string
    spaceId: string
    direct: boolean
    ...
    return <section aria-label="All discussions" className="flex min-h-0 flex-1 flex-col">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-5 py-3">
            {rows.map((topic) => {
                ...
                return <div key={topic.id} className="group flex items-center gap-2 border-b border-border/60 py-1">
