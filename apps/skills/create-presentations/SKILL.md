...
description: >-
  Create PDF presentations and slide decks from natural language requests using knowledge base context. Use when the user wants to create a presentation, pitch deck, or slide deck.
license: MIT
