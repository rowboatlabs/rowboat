...
Rowboat supports any OpenAI-compatible backend via `~/.rowboat/config/models.json`. Example using [Atlas Cloud](https://www.atlascloud.ai/?utm_source=github&utm_medium=link&utm_campaign=rowboat) (DeepSeek, Qwen, GLM, Kimi, MiniMax, and more):
